...
import { J as parseQuery, x as hasProtocol, r as joinURL, W as withTrailingSlash, V as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-769d0946><div class="max-w-520px text-center" data-v-769d0946><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-769d0946>${ssrInterpolate(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-769d0946>${ssrInterpolate(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-769d0946>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-769d0946>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-769d0946"]]);

export { error404 as default };
//# sourceMappingURL=error-404-CSbP_7Tz.mjs.map
