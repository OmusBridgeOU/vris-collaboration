/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: f11bb037232bb2b026a8a47a633fc541)
...
interface __BaseEnv_Env {
	...
	TABLE_CONFIG: "{\"access_tokens\":{\"primaryKey\":\"id\",\"columns\":[\"id\",\"label\",\"created_at\"],\"writableColumns\":[\"id\",\"label\"]}}";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "TABLE_CONFIG">> {}
}
