...
layers/
  main/
    app/
      test/
        components/
          HaContentCard.spec.ts
          HoTheHeader.spec.ts
          HtVenueMapSection.spec.ts
        composables/
          useApi.spec.ts
...
## File: layers/main/app/test/components/HaContentCard.spec.ts
```typescript
import { mount } from '@vue/test-utils'
import { describe, expect, test } from 'vitest'
...
## File: layers/main/app/test/components/HtVenueMapSection.spec.ts
```typescript
import { mount } from '@vue/test-utils'
